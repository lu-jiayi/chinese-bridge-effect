...
excel_data = pd.read_excel("C:/Users/aldos/Desktop/chinese-bridge-effect/bridge_stimuli_exp2.xlsx", sheet_name=0)
...
# Print confirmation
print("JSON file created successfully: output2.json")