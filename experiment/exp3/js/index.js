...
///add bridge verb items to the presentation list (lacking lexicalization information). 4 sentences: 2 bridge verbs, each with 2 conditions (declarative and long)
...
///add  unknown verb items to the presentation list (lacking lexicalization information). 12 sentences: 6 unknown verbs, each with 2 conditions (declarative and long)
for (var i = 0; i < 6; i++){
  presentation_list.push(unknown_verb_list[i]*10 + 100001);
  presentation_list.push(unknown_verb_list[i]*10 + 100002);
};
console.log(presentation_list);
/// add lexicalization information to the presentation list: randomly select 16 from 1-32.
...
/// add fillers
halved_fillers = [1,2,5,6,9,10,13,14,17,18,21,22,25,26,29,30]
for (var i = 0; i < 16; i++){
  presentation_list.push(900000+halved_fillers[i]);
};
